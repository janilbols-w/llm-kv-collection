...
RUN_REDIS_REMOTE_SERVER="${RUN_REDIS_REMOTE_SERVER:-${SCRIPT_DIR}/run_redis_remote_server.sh}"
RUN_CLEANUP_VLLM_RESIDUAL="${RUN_CLEANUP_VLLM_RESIDUAL:-${SCRIPT_DIR}/cleanup_vllm_residual.sh}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${SCRIPT_DIR}/outputs/e2e_lmcache_cross_instance}"
